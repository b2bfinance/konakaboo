...
export default ({ open, onClose, title, links, brand, disclaimer, description, detailed }) => {
  const classes = useStyles();

  return (
    <Drawer classes={classes} anchor="right" open={open} onClose={onClose}>
      <ProductMoreInfoHeader brand={brand} title={title} logo={links.logo} onClose={onClose} />
      <ProductMoreInfoBody description={description} detailed={detailed} disclaimer={disclaimer} />
